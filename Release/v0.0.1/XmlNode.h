 ...
 * will generate the whole DM using instances of this class.
 * <p>
 * XmlNodes contain all the data required to restructure the xml representation of the object graph:
 * \li name
 * \li prefix
 * \li attributes
 * \li namespace declarations
 * \li sub elements which can be of any DMObject type.
 * <p>
